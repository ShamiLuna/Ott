        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Center(child: Text("Already registered with email or Google/Facebook?",style: TextStyle(fontSize: 15,fontStyle: FontStyle.italic,decoration: TextDecoration.underline ,color: Colors.yellow),)),
            ),
            ElevatedButton(
